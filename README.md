...
| ------------- | ------------- | ------------ | ------------ | ------------ |
| [Mastercard](https://docs.multisafepay.com/docs/card-payments)  | ![image](methods/mastercard.png)  | ![image](methods/mastercard@2x.png) | ![image](methods/mastercard@3x.png) | ![image](methods/mastercard.svg) |
| [Maestro](https://docs.multisafepay.com/docs/card-payments)  | ![image](methods/maestro.png)  | ![image](methods/maestro@2x.png) | ![image](methods/maestro@3x.png) | ![image](methods/maestro.svg) |
| [Visa](https://docs.multisafepay.com/docs/card-payments)  | ![image](methods/visa.png)  | ![image](methods/visa@2x.png) | ![image](methods/visa@3x.png) | ![image](methods/visa.svg) |
| [V Pay](https://docs.multisafepay.com/docs/card-payments)  | ![image](methods/v_pay.png)  | ![image](methods/v_pay@2x.png) | ![image](methods/v_pay@3x.png) | ![image](methods/v_pay.svg) |
| [Amex](https://docs.multisafepay.com/docs/card-payments)  | ![image](methods/amex.png)  | ![image](methods/amex@2x.png) | ![image](methods/amex@3x.png) | ![image](methods/amex.svg) |
| [iDEAL](https://docs.multisafepay.com/docs/ideal)  | ![image](methods/ideal.png)  | ![image](methods/ideal@2x.png) | ![image](methods/ideal@3x.png) | ![image](methods/ideal.svg) |
| [iDEAL QR](https://docs.multisafepay.com/docs/ideal#ideal-qr)  | ![image](methods/ideal-qr.png)  | ![image](methods/ideal-qr@2x.png) | ![image](methods/ideal-qr@3x.png) | ![image](methods/ideal-qr.svg) |
| [Bancontact](https://docs.multisafepay.com/docs/bancontact)	  | ![image](methods/bancontact.png)  | ![image](methods/bancontact@2x.png) | ![image](methods/bancontact@3x.png) | ![image](methods/bancontact.svg) |
| [Alipay](https://docs.multisafepay.com/docs/alipay)  | ![image](methods/alipay.png?)  | ![image](methods/alipay@2x.png?) | ![image](methods/alipay@3x.png?) | ![image](methods/alipay.svg?) |
| [Banktransfer-EN](https://docs.multisafepay.com/docs/bank-transfer)  | ![image](methods/banktransfer-en.png)  | ![image](methods/banktransfer-en@2x.png) | ![image](methods/banktransfer-en@3x.png) | ![image](methods/banktransfer-en.svg) |
| [Banktransfer-NL](https://docs.multisafepay.com/docs/bank-transfer)  | ![image](methods/banktransfer-nl.png)  | ![image](methods/banktransfer-nl@2x.png) | ![image](methods/banktransfer-nl@3x.png) | ![image](methods/banktransfer-nl.svg) |
| [Banktransfer-DE](https://docs.multisafepay.com/docs/bank-transfer)  | ![image](methods/banktransfer-de.png)  | ![image](methods/banktransfer-de@2x.png) | ![image](methods/banktransfer-de@3x.png) | ![image](methods/banktransfer-de.svg) |
| [Banktransfer-ES](https://docs.multisafepay.com/docs/bank-transfer)  | ![image](methods/banktransfer-es.png)  | ![image](methods/banktransfer-es@2x.png) | ![image](methods/banktransfer-es@3x.png) | ![image](methods/banktransfer-es.svg) |
...
| [Paysafecard](https://docs.multisafepay.com/docs/paysafecard)  | ![image](methods/paysafecard.png)  | ![image](methods/paysafecard@2x.png) | ![image](methods/paysafecard@3x.png) | ![image](methods/paysafecard.svg) |
| [TrustPay](https://docs.multisafepay.com/docs/trustpay)  | ![image](methods/trustpay.png)  | ![image](methods/trustpay@2x.png) | ![image](methods/trustpay@3x.png) | ![image](methods/trustpay.svg) |
| [Trustly](https://docs.multisafepay.com/docs/trustly)  | ![image](methods/trustly.png)  | ![image](methods/trustly@2x.png) | ![image](methods/trustly@3x.png) | ![image](methods/trustly.svg) |
| [Directdebit-EN](https://docs.multisafepay.com/docs/sepa-direct-debit)  | ![image](methods/directdebit-en.png)  | ![image](methods/directdebit-en@2x.png) | ![image](methods/directdebit-en@3x.png) | ![image](methods/directdebit-en.svg) |
| [Directdebit-NL](https://docs.multisafepay.com/docs/sepa-direct-debit)  | ![image](methods/directdebit-nl.png)  | ![image](methods/directdebit-nl@2x.png) | ![image](methods/directdebit-nl@3x.png) | ![image](methods/directdebit-nl.svg) |
...
| [Request to Pay](https://docs.multisafepay.com/docs/request-to-pay)  | ![image](methods/RTP.png)  | ![image](methods/RTP@2x.png) | ![image](methods/RTP@3x.png) | ![image](methods/RTP.svg) |
| [Apple Pay](https://docs.multisafepay.com/docs/apple-pay)  | ![image](methods/applepay.png) | ![image](methods/applepay@2x.png) | ![image](methods/applepay@3x.png) | ![image](methods/applepay.svg) |
| [Google Pay](https://docs.multisafepay.com/docs/google-pay)  | ![image](methods/googlepay.png) | ![image](methods/googlepay@2x.png) | ![image](methods/googlepay@3x.png) | ![image](methods/googlepay.svg) |
| [Credit card](https://docs.multisafepay.com/docs/card-payments)  | ![image](methods/creditcard.png) | ![image](methods/creditcard@2x.png) | ![image](methods/creditcard@3x.png) | ![image](methods/creditcard.svg) |
| [Credit card (Alternative)](https://docs.multisafepay.com/docs/card-payments)  | ![image](methods/creditcard2.png) | ![image](methods/creditcard2@2x.png) | ![image](methods/creditcard2@3x.png) | ![image](methods/creditcard2.svg) |
| [Credit card (Alternative Black)](https://docs.multisafepay.com/docs/card-payments)  | ![image](methods/creditcard3.png) | ![image](methods/creditcard3@2x.png) | ![image](methods/creditcard3@3x.png) | ![image](methods/creditcard3.svg) |
| Revolut  | ![image](methods/revolut.png) | ![image](methods/revolut@2x.png) | ![image](methods/revolut@3x.png) | ![image](methods/revolut.svg) |
| [in3](https://docs.multisafepay.com/docs/in3)  | ![image](methods/in3.png) | ![image](methods/in3@2x.png) | ![image](methods/in3@3x.png) | ![image](methods/in3.svg) |
...
| Payment method  | @1x | @2x | @3x | SVG |
| ------------- | ------------- | ------------ | ------------ | ------------ |
| [Alipay+](https://docs.multisafepay.com/docs/alipay-plus)  | ![image](methods/alipayplus.png)  | ![image](methods/alipayplus@2x.png) | ![image](methods/alipayplus@3x.png) | ![image](methods/alipayplus.svg) |
| [Alipay CN](https://docs.multisafepay.com/docs/alipay-plus)  | ![image](methods/alipay-cn.png)  | ![image](methods/alipay-cn@2x.png) | ![image](methods/alipay-cn@3x.png) | ![image](methods/alipay-cn.svg) |
| [Alipay HK](https://docs.multisafepay.com/docs/alipay-plus)  | ![image](methods/alipay-hk.png)  | ![image](methods/alipay-hk@2x.png) | ![image](methods/alipay-hk@3x.png) | ![image](methods/alipay-hk.svg) |
| [Kakao Pay](https://docs.multisafepay.com/docs/alipay-plus)  | ![image](methods/kakaopay.png)  | ![image](methods/kakaopay@2x.png) | ![image](methods/kakaopay@3x.png) | ![image](methods/kakaopay.svg) |
| [Alipay+ dots](https://docs.multisafepay.com/docs/alipay-plus)  | ![image](methods/alipayplus-dots.png)  | ![image](methods/alipayplus-dots@2x.png) | ![image](methods/alipayplus-dots@3x.png) | ![image](methods/alipayplus-dots.svg) |
| [GCash](https://docs.multisafepay.com/docs/alipay-plus)  | ![image](methods/gcash.png)  | ![image](methods/gcash@2x.png) | ![image](methods/gcash@3x.png) | ![image](methods/gcash.svg) |
...
| Biercheque  | ![image](giftcards/Biercheque.png)  | ![image](giftcards/Biercheque@2x.png) | ![image](giftcards/Biercheque@3x.png) | ![image](giftcards/Biercheque.svg) |
...
| BoekenVoordeel  | ![image](giftcards/BoekenVoordeel.png)  | ![image](giftcards/BoekenVoordeel@2x.png) | ![image](giftcards/BoekenVoordeel@3x.png) | ![image](giftcards/BoekenVoordeel.svg) |
| [Edenred](https://docs.multisafepay.com/docs/edenred)  | ![image](giftcards/edenred.png)  | ![image](giftcards/edenred@2x.png) | ![image](giftcards/edenred@3x.png) | ![image](giftcards/edenred.svg) |
| [Edenred Ticket EcoCheque](https://docs.multisafepay.com/docs/edenred)  | ![image](giftcards/edenred-ticketccocheque.png)  | ![image](giftcards/edenred-ticketccocheque@2x.png) | ![image](giftcards/edenred-ticketccocheque@3x.png) | ![image](giftcards/edenred-ticketccocheque.svg) |
| [Edenred Ticket Compliments](https://docs.multisafepay.com/docs/edenred)  | ![image](giftcards/edenred-ticketcompliments.png)  | ![image](giftcards/edenred-ticketcompliments@2x.png) | ![image](giftcards/edenred-ticketcompliments@3x.png) | ![image](giftcards/edenred-ticketcompliments.svg) |
| [Edenred Ticket Restaurant](https://docs.multisafepay.com/docs/edenred)  | ![image](giftcards/edenred-ticketrestaurant.png)  | ![image](giftcards/edenred-ticketrestaurant@2x.png) | ![image](giftcards/edenred-ticketrestaurant@3x.png) | ![image](giftcards/edenred-ticketrestaurant.svg) |
| [Edenred Ticket Sport & Culture](https://docs.multisafepay.com/docs/edenred)  | ![image](giftcards/edenred-ticketsport-culture.png)  | ![image](giftcards/edenred-ticketsport-culture@2x.png) | ![image](giftcards/edenred-ticketsport-culture@3x.png) | ![image](giftcards/edenred-ticketsport-culture.svg) |
...
| GezondheidsBon  | ![image](giftcards/Gezondheidsbon.png)  | ![image](giftcards/Gezondheidsbon@2x.png) | ![image](giftcards/Gezondheidsbon@3x.png) | ![image](giftcards/Gezondheidsbon.svg) |
...
| Huis & Tuin Cadeau  | ![image](giftcards/Huisentuincadeau.png)  | ![image](giftcards/Huisentuincadeau@2x.png) | ![image](giftcards/Huisentuincadeau@3x.png) | ![image](giftcards/Huisentuincadeau.svg) |
| KidsCadeau  | ![image](giftcards/Kidscadeau.png)  | ![image](giftcards/Kidscadeau@2x.png) | ![image](giftcards/Kidscadeau@3x.png) | ![image](giftcards/Kidscadeau.svg) |
| Klus Cadeau  | ![image](giftcards/Kluscadeau.png)  | ![image](giftcards/Kluscadeau@2x.png) | ![image](giftcards/Kluscadeau@3x.png) | ![image](giftcards/Kluscadeau.svg) |
